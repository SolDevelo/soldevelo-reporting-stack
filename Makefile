...
bootstrap-export: ## Export source PostgreSQL tables to NDJSON for bulk import. TABLES=schema.t1,... (default: all from SOURCE_PG_TABLE_ALLOWLIST)
	@bash scripts/bootstrap/export.sh
